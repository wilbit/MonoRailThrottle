...
using MonoRailThrottle.Providers;

namespace MonoRailThrottle
{
    //TODO хранилище настроек лимитов: может быть прочитано из конфига с помощью ThrottlePolicy.FromStore(new PolicyConfigurationProvider())
    /// <summary>
    /// Rate limits policy
    /// </summary>
    [Serializable]
